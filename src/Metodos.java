...
public class Metodos {
    ...
    public void Pagar(){
        ...
        System.out.println("Ingrese la cantidad a jugar: ");
        dinero.nextInt();
    ...
    public void Comprobar(){
        if (numero1==numero2 && numero1==numero3){
            System.out.println("¡¡¡ YOU ARE THE WINNER !!!"+dinero);
        }
        ...
        else if (numero1==numero5 && numero1==numero9){
            System.out.println("¡¡¡ YOU ARE THE WINNER !!!"+dinero);
        }
        else if (numero7== numero5 && numero7==numero3){
            System.out.println("¡¡¡ YOU ARE THE WINNER !!!"+dinero);
        }
        else
